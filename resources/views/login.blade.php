...
<!-- Mirrored from zoyothemes.com/tapeli/html/auth-login by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Sep 2024 11:26:07 GMT -->
                                ...
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    <div class="mb-4 p-0">
                                        <a class='auth-logo' href='index.html'>
                                            <img src="admin/assets/images/logo.webp" alt="logo-dark" class="mx-auto" height="28" />
                                        </a>
                                    </div>
    
                                    <div class="pt-0">
                                        <form action="https://zoyothemes.com/tapeli/html/index.html" class="my-4">
                        ...
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                ...
                                <div class="auth-image">
                                    <img src="admin/assets/images/authentication.svg" class="mx-auto img-fluid"  alt="images">
                                </div>
                            </div>
                        </div>
                    </div>
